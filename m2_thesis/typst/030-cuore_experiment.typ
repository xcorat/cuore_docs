...
Among contemporary 0#nbb experiments, CUORE employs a unique approach to achieve both ton-scale active mass and exceptionally high energy resolution. This is made possible by combining the ultra-cold bolometric technique with the direct use of the #te130 isotope. CUORE represents the culmination of a decades-long saga of bolometric 0#nbb searches. Successive precursor experiments systematically resolved profound engineering challenges, yielding incremental but vital improvements in background radiation mitigation, noise reduction, and cryogenic scalability.

To achieve its target sensitivity, the experiment relies on a highly modular architecture. The core detector array comprises 988 #teo2 crystals, which function simultaneously as the primary 0#nbb source volume and the thermal energy absorber. These macro-calorimeters are instrumented with highly sensitive Neutron Transmutation Doped (NTD) Germanium thermistors and operated at a strict base temperature of roughly 10 mK. Reaching and maintaining this extreme thermal state for a ton-scale mass requires a massive, custom-built, multistage cryogen-free dilution refrigerator.

Operating such a massive and thermally sensitive array demands pristine environmental isolation. To severely suppress internal and environmental radioactivity, the cryostat itself incorporates nested layers of ancient Roman and modern lead shielding. Furthermore, the entire apparatus is housed within a dedicated infrastructure—the CUORE hut—which is equipped with sophisticated mechanical suspensions and continuous Faraday cages to explicitly isolate the delicate detectors from seismic vibrations and electromagnetic noise. Finally, to adequately attenuate the cosmic muon flux, the experiment operates beneath approximately a kilometer of granite at the Laboratori Nazionali del Gran Sasso (LNGS), the world's largest deep underground laboratory.
