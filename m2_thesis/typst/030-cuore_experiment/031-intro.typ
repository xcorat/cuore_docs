...
The foundational concepts of CUORE trace back to Ettore Fiorini's and collaborators' 1967 0#nbb results and subsequent research on low-temperature Germanium detectors. Developing a ton-scale bolometric array required mitigating background radiation and proportionally scaling cryogenic infrastructure. Consequently, CUORE was developed through a sequence of pathfinder experiments, each sequentially addressing specific operational challenges to inform the final design.

==== Initial bolometric detectors
Early efforts measured 2#nbb decay using single-crystal bolometers. The Milan Double Beta Decay Experiment (MiDBD), starting in 1997, was the first 0#nbb search to deploy a multi-layer array of #teo2 crystals. It consisted of 20 crystals ($3 times 3 times 3 "cm"^3$), totaling 6.8 kg of active mass. MiDBD used custom Oxygen-Free High Thermal Conductivity (OFHC) copper frames and pioneered the independent electronic control for each crystal. These innovations proved essential for maintaining uniform detector response and minimizing intrinsic radiation. A subsequent upgrade, MiDBD-II, introduced a more compact design with enhanced shielding. It achieved a background rate of roughly $0.3$ counts/(keV$·$kg$·$yr) (ckky) and an energy resolution between 5 to 15 keV, successfully establishing the feasibility of constructing larger arrays.

==== CUORECINO
Building on these initial successes, the next major milestone was CUORECINO, designed specifically to test the viability of scaling up both individual crystal size and total array mass. Operating from 2003 to 2008 with 40.7 kg of #teo2, it featured 44 large ($5 times 5 times 5 "cm"^3$) and 18 standard crystals. Producing the larger crystals without sacrificing thermodynamic properties required shifting the growth axis to $chevron.l 1 med  1 med 0 chevron.r$. CUORECINO demonstrated an energy resolution#footnote[should I say $sigma$?] of 4.2 keV at 5407 keV and $~5.8$ keV at the 2615 keV $208$Tl calibration line, proving that macro-bolometers could achieve resolutions comparable to contemporary Germanium detectors.

Crucially, both MiDBD and CUORECINO identified the primary backgrounds that a ton-scale array would face: multi-Compton $gamma$ events originating from #th232 contamination and degraded alphas from surface contaminants on the crystals and facing materials. Analyzing the specific shape of these alpha peaks enabled precise background modeling. Internal contaminants produced sharp peaks at their nominal Q-values, while surface contaminants caused asymmetric peaks with distinct low-energy tails. To mitigate these backgrounds, targeted R&D campaigns focused on establishing strict radio-assay standards, optimizing crystal growth, and developing advanced surface cleaning protocols for both the #teo2 crystals and adjacent copper components. These rigorous efforts yielded refined assembly procedures and guided the selection of ultra-pure materials, such as NOSV copper for the detector frames, radiopure PTFE crystal supports, and flat Cu-PEN readout cables—directly informing CUORE's final construction parameters#footnote[One important outcome from these tests were the development optimal cleaning procedures for copper components, which consists of a rigorous sequence of tumbling, electro-polishing, chemical etching, and magnetron plasma cleaning].

==== CUORE-0
In 2013, the first full CUORE-like tower—designated as the "0th" tower (CUORE-0)—was installed in the legacy Hall-A cryostat. Serving as a direct test of the newly developed assembly and cleaning protocols, it comprised 52 large crystals containing 39 kg of #teo2. Operating until 2015, CUORE-0 accumulated 9.8 kg$·$yr of exposure with an 80% physics duty cycle.
// , indicating that 80% of the operational time was dedicated to uninterrupted physics data acquisition, with the remainder allocated to calibration and cryogenic maintenance.
