...
- If candidate events are observed, the half-life is measured as $t^(0nu)_(1"/"2) = ln 2 dot T epsilon thin N_(beta beta)/N_("peak")$. #footnote[T? what are the params here?]
- The detector's sensitivity depends crucially on its background level, energy resolution, and total exposure.
- The number of background events in the region of interest is given by $Delta B$.
- The half-life sensitivity is defined as $S^(0 nu)_(1"/"2) = ln 2 dot epsilon (x eta)/n_sigma N_A/cal(M)_A (M T)/sqrt(M T Delta B)$, when the background term $M T Delta B = O(1)$, this sensitivity scales linearly with exposure.

=== History of CUORE #footnote[focus on showing how the prior experiments were vital in learning for CUORE ]
- The seeds of the CUORE experiment were planted over half a century ago. Its foundational concepts trace back to the pioneering 1967 2#nbb decay results by Ettore Fiorini, alongside seminal papers by Frank and collaborators on low-temperature Germanium detectors about a decade later.

==== Initial bolometric detectors
- Operating bolometric detectors at ultra-low temperatures presents immense engineering challenges. Consequently, CUORE is the culmination of decades of progressive research across multiple smaller-scale experiments.#footnote[some redundant ideas here]
...
- The first 0#nbb experiment to deploy an array of #teo2 crystals was the Milan Double Beta Decay Experiment (MiDBD), which began operations in 1997. MiDBD was a landmark achievement, representing the integration of numerous incremental improvements in radiopure cryogenics, material selection, and crystal growth.
  ...
  - Notable technical advancements included a custom Oxygen-Free High Thermal Conductivity (OFHC) copper tower frame and a sophisticated front-end electronic system that allowed for the independent control of each crystal's operating parameters.#footnote[this sentense need to be corrected and made more relavant]
  - A subsequent upgrade, MiDBD-II, introduced a more compact design with enhanced shielding and improved coincidence analysis. It achieved a background rate of $~0.3$ counts/(keV$·$kg$·$yr) (ckky) and an energy resolution ranging from 5 to 15 keV. #footnote[combine with the above]
...
- Both MiDBD and CUORECINO were vital for characterizing and mitigating the backgrounds that a ton-scale array would face.
  ...
  - To combat these backgrounds, targeted R&D campaigns—such as the RAD, CAW, TTT, and CCVR tests—were conducted. #footnote[expand this sentence, remove the seperate references to different 3-letters]
  - These efforts yielded significantly improved protocols for detector production and assembly, ranging from crystal growth and cleaning procedures to custom mounting mechanisms for the crystals and semiconductor thermistors. It also guided the strict selection of radiopure materials, such as PEN-insulated copper (PenCu) cables. #footnote[need to make this a bit more relevant, maybe add other improvements?]

==== CUORE-0
- Following nearly a decade of targeted improvements#footnote[redundant] for the ton-scale CUORE project, the first full CUORE-like tower was constructed and installed in the legacy Hall-A cryostat in 2013.
- Dubbed CUORE-0#footnote[0th tower], it consisted of 52 large ($5 times 5 times 5 "cm"^3$) crystals arranged into 13 floors of four. With a total #teo2 mass of 39 kg, its physical structure and production mechanisms were designed to be fairly identical to those of the final 19 towers of CUORE.
- Operating from 2013 to 2015, CUORE-0 accrued 9.8 kg$·$yr of exposure with a physics duty cycle of 80%. #footnote[this needs explanation, 80% duty cycle means what? without the repair/warmup times?]
