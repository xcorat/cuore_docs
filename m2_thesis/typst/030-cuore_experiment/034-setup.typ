...
=== LNGS
Since the pioneering operation of a 22 g #teo2 crystal in 1989, the Laboratori Nazionali del Gran Sasso (LNGS) has been the permanent home of this bolometric research program. Situated in the Apennine Mountains beneath Corno Grande, the granite mountain provides an average rock overburden of 3600 meters of water equivalent (m.w.e.). This immense shielding suppresses the cosmic muon flux by six orders of magnitude relative to the surface, a strict necessity for ton-scale rare-event searches. The underground complex features three vast experimental halls, with CUORE operating inside Hall A. Supporting infrastructure, including computing centers and mechanical workshops, is conveniently located at the above-ground campus at the mountain's foothills.
...
=== Cryostat
The CUORE cryostat is a custom-designed, multistage, cryogen-free dilution refrigerator enclosing an experimental volume of approximately one cubic meter. Cooling an unprecedented detector mass in a practical timeframe requires a massive three-phase system: a Fast Cooling System (FCS), five Pulse Tube (PT) cryocoolers, and a high-power #super[3]He/#super[4]He Dilution Unit (DU).

==== Vessels
The system consists of six nested, coaxial vessels corresponding to distinct thermal stages: 300 K (room temperature), 40 K, 4 K, 600 mK (Still), 50 mK (Heat Exchanger), and 10 mK (Mixing Chamber). The 300 K and 4 K vessels are completely vacuum-tight, partitioning the cryostat into two distinct regions: the Outer Vacuum Chamber (OVC) and the Inner Vacuum Chamber (IVC).
...
While mechanically isolated via low-thermal-conductivity materials, the TSP must still be cooled to base temperature. It is thermally anchored to the 10 mK Mixing Chamber plate using four flexible copper connectors—each composed of dozens of ultra-thin NOSV copper leaves—which provide the necessary thermalization while preventing the transmission of rigid mechanical vibrations.

==== Shields
Heavy lead shielding is integrated directly into the cryogenic volumes to suppress environmental $gamma$ rays originating from the natural $238$U and $232$Th decay chains. A 6 cm thick lateral and bottom shield, weighing approximately 5 tonnes, surrounds the detector array. It is constructed from ancient Roman lead recovered from a 1st-century AD shipwreck, prized because its $210$Pb radioactive isotope inventory has completely decayed over the millennia. This Roman lead shield is suspended inside the IVC from the 600 mK plate but is thermally anchored to the 4 K stage; this intercepts the radiative heat load, preventing it from overwhelming the ultra-cold 10 mK stage. Additionally, a 30 cm thick top shield of modern lead (roughly 2 tonnes) sits directly above the TSP, thermally anchored at 10 mK.
