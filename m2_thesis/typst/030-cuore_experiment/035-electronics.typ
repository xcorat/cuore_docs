...
The signal readout chain bridges the ultra-cryogenic environment with the room-temperature data acquisition systems. Inside the cryostat, the PEN-Cu cables route the analog signals along the detector towers, and from the 10 mK Mixing Chamber, a system of woven ribbon cables—consisting of twisted pairs of NbTi wires with a CuNi coating—takes over to carry the signals up through the successive thermal stages to the outside of the cryostat#footnote[Is this correct? arXiv:1805.06209v2 [physics.ins-det] --  :sec3]. From here, external multi-wire cables carry the signals into the adjacent Faraday cage to the preamplifiers, where they are actively filtered and digitized.
...
Crucially, the bias current for the NTD thermistors is supplied completely independently by a remote-controlled DC power supply (Keithley 2231A-30-3). This configuration galvanically#footnote[this is the correct word, ya?] isolates the sensitive NTD sensors—meaning there is no direct electrical conduction path between the sensor bias lines and the main electronics power ground. This isolation reduces the formation of ground loops and blocks external electrical noise from propagating into the cryostat.
