...
The crystals are securely suspended within these copper frames using custom polytetrafluoroethylene (PTFE) spacers. These spacers serve a dual purpose: they clamp the absorbers to prevent vibrational noise and establish a precisely calibrated, weak thermal link to the copper heat sink.
